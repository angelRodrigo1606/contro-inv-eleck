                ...
                <div class="p-6 text-theme-text">
                    <div class="flex justify-between items-center mb-4">
                        ...
                        <div class="space-x-2">
                            ...
                            <a href="{{ route('reports.exits.export', ['format' => 'pdf'] + request()->all()) }}" class="inline-flex items-center px-4 py-2 bg-brand-secondary border border-transparent rounded-md font-semibold text-xs text-theme-text uppercase tracking-widest hover:bg-brand-secondary/80 transition-colors">PDF</a>
                        </div>
                    </div>
